...
@section('header', 'Buat Sertifikat')
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-100 overflow-hidden">
        <div class="p-6 sm:p-8">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-medium text-gray-900">Form Buat Sertifikat</h3>
            ...
            <form action="{{ route('admin.sertifikat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_sertifikat" id="nomor_sertifikat" value="{{ old('nomor_sertifikat') }}" required class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg" placeholder="800.1.12.a/589/2/KOMINFOTIK/2024">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_terbit" id="tanggal_terbit" value="{{ old('tanggal_terbit') }}" required class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_mulai_magang" id="tanggal_mulai_magang" value="{{ old('tanggal_mulai_magang') }}" required class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_selesai_magang" id="tanggal_selesai_magang" value="{{ old('tanggal_selesai_magang') }}" required class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_instansi" id="nama_instansi" value="{{ old('nama_instansi') }}" class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                        @error('nama_instansi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" name="lokasi_instansi" id="lokasi_instansi" value="{{ old('lokasi_instansi') }}" class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="kepala_dinas" id="kepala_dinas" value="{{ old('kepala_dinas') }}" class="mt-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-lg">
                        @error('kepala_dinas')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
